<template>
  <svg class="logo" viewBox="0 0 85 46" fill="none" xmlns="http://www.w3.org/2000/svg">
    <linearGradient id="bg-gradient" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop id="transparent" offset="0" stop-color="transparent">
        <animate 
      ...
      <stop id="black" offset="0" stop-color="black">
        <animate 
          attributeName="offset" 
          begin="0s" 
          dur="2s" 
